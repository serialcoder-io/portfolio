  ...
  return (
    <section id="about" className="max-w-6xl mx-auto px-6 py-10 text-base-content">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
        {/* LEFT - Profile Card */}
        <aside className="bg-base-200 rounded-2xl shadow-md p-6 flex flex-col items-center gap-y-6 sticky top-2">
          {/* Image */}
          <Image
            src="/profile.png"
            alt="Profile photo"
          ...
          <div className="flex gap-3">
            <ExternalIconLink
              ...
              className="bg-base-200 hover:bg-primary hove:text-primary-content"
            />
            <ExternalIconLink
